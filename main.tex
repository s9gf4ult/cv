...
\subsection{Projects}
\cventry {2013 (currently working
  on)}{Haskell}{HDBC-postgresql}{\hlink{https://github.com/s9gf4ult/hdbc-postgresql}}{}{%
  The fork of original HDBC driver to work with new HDBC.}

\cventry {2013 (currently working
  on)}{Haskell}{HDBC}{\hlink{https://github.com/s9gf4ult/hdbc}}{}{Developing
  new flexible HDBC with some set of features.}
    
\cventry
    {2013}{Haskell}{quickcheck-assertions}%
    {\hlink{https://github.com/s9gf4ult/quickcheck-assertions}}{}{%
      Package for property-based testing with pretty-printed test results.}
...
\cventry{2011--2012}{Python}{Track Deal}%
        {\hlink{https://github.com/s9gf4ult/track-deal}}{}{%
          Developing Python program for tracking stock market operations.  I
          created this program for myself because there was no good Open Source
          trader log program.}

\section{Computer skills}
\cvitem{Linux}{%
  Experienced Linux user and administrator (Linux is my main home and work operating system):
  \begin{itemize}
