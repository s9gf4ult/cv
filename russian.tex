...
\section{Умения}
  ...
  На домашнем компьютере Gentoo более 4 лет.
  
\cvitem{Программирование}{%
  \begin{itemize}
  \item Ruby -- опыт разрабтки двух приложений на Ruby on Rails
  ...
  \item Haskell -- язык от работы с которым я получаю удовольствие, опыт более полутора лет
  \item Git, SVN, Hg -- контроль версий, всему придпочитаю Git.
  \end{itemize}}

\cvitem{Администрирование}{%
  \begin{itemize}
  \item Apache -- конфигурирование и установка модулей
  \item nginx -- конфигурирование
