...
\cventry{2014 -- Сейчас}{Haskell программист}{AdTel}{Удаленная работа}{}{}{%
  \begin{itemize}
  \item Сделал сервис аутентификации по протоколу
    \bb{Oauth2}. \bb{Oauth2} сервер в последствии был выделен в
    отдельный пакет и подключен к сервису как \bb{Yesod subsite}.
