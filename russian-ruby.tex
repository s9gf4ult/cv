...
\item Web:
  ...
  \item Ruby
    ...
    \end{itemize}
  \item HTML/CSS: небольшой опыт верстки, Blueprint CSS
  \item JavaScript: JQuery, AngularJS
  \item HTTP: понимание принципов протокола, REST
...
\begin{itemize}
\item Linux: Опытный пользователь и администратор Linux (на
  рабочей станции использую Gentoo)
